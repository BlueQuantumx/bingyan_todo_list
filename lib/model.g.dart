...
extension TaskListQueryWhereDistinct
  ...
  QueryBuilder<TaskList, TaskList, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TaskListQueryProperty
  ...
  QueryBuilder<TaskList, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
...
Task _taskDeserialize(
  ...
  object.due = reader.readDateTimeOrNull(offsets[2]);
  object.id = id;
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> createdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
